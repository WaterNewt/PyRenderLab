...
INVALID_UPDATE_TYPE = "Update argument must be a function"
...
INVALID_SIZE_TYPE = "`size` must be a one-dimensional tuple with 2 items (width and height)"
INVALID_WINDOW_TITLE_TYPE = "`window_title` must be a string"
